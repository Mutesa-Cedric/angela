  ...
  contentEl.innerHTML = `
    <div class="sar-header-info">
      <div class="sar-meta">
        ...
        <span class="sar-value">${data.entity_id}</span>
      </div>
      <div class="sar-meta">
    ...
    <div class="sar-narrative">${escapeHtml(data.narrative)}</div>
...
<style>
  ...
  .narrative { font-size: 13px; white-space: pre-wrap; line-height: 1.7; }
...
<div class="narrative">${escapeHtml(currentData.narrative)}</div>
